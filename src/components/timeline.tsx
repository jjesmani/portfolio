			...
			<div className="flex flex-col">
				<div className="flex flex-col items-center border-b border-zinc-200">
					...
					<ul className="flex flex-col gap-4 text-center pb-6">
						<li className="flex flex-col gap-1 text-2xl font-bold">
							Fullstack Intern @ enygma.ai
						</li>
						<li className="flex flex-col gap-2 font-regular text-lg">
							One of the primary developers at the company,
							responsible for developing and integrating a full
							web application with a machine learning model.
						</li>
					</ul>
				</div>
				<div className="flex flex-col items-center border-b border-zinc-200 mt-8">
					...
					<ul className="flex flex-col gap-4 text-center pb-6">
						...
						<li className="flex flex-col gap-2 font-regular text-lg">
							Studied Software Engineering at Arizona State
							University. Focus includes practical projects and
							coursework.
						</li>
					</ul>
				</div>
				<div className="flex flex-col items-center border-b border-zinc-200 mt-8">
					...
					<ul className="flex flex-col gap-4 text-center pb-6">
						...
						<li className="flex flex-col gap-2 font-regular text-lg">
							Learn fullstack of React, Node.js, Express.js, and
							MongoDB. The program include practical project and
							coursework.
						</li>
					</ul>
				</div>
				<div className="flex flex-col items-center border-zinc-200 mt-8">
					...
					<ul className="flex flex-col gap-4 text-center pb-6">
						...
						<li className="flex flex-col gap-2 font-regular text-lg">
							University preparation for pre-departure to United
							States. Focus on basic programming knowledge.
						</li>
					</ul>
				</div>
			</div>
